...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "Explorer": { en: "Explorer", fr: "Explorer" },
  "Total Acquisitions": { en: "Total Acquisitions", fr: "Total des Acquisitions" },
  "Est. Portfolio Value": { en: "Est. Portfolio Value", fr: "Valeur Est. du Portefeuille" },
  "Active Operations": { en: "Active Operations", fr: "Opérations Actives" },
  "in progress": { en: "in progress", fr: "en cours" },
  "secure vaults": { en: "secure vaults", fr: "coffres-forts sécurisés" },
  "legacy trust artifacts": { en: "legacy trust artifacts", fr: "artefacts patrimoniaux" },
  "courier cargo transit": { en: "courier cargo transit", fr: "transit cargo" },
  "curation vetting": { en: "curation vetting", fr: "vérification curatoriale" },
  "Recent Acquisitions": { en: "Recent Acquisitions", fr: "Acquisitions Récentes" },
  "View Full Cabinet": { en: "View Full Cabinet", fr: "Voir le Cabinet Complet" },
  "Exclusive Curator Preview": { en: "Exclusive Curator Preview", fr: "Aperçu Conservateur Exclusif" },
  "Express Investment Interest": { en: "Express Investment Interest", fr: "Exprimer l'Intérêt d'Investissement" },
  "Private Placement Advisory": { en: "Private Placement Advisory", fr: "Conseil de Placement Privé" },
  "Export Portfolio Report": { en: "Export Portfolio Report", fr: "Exporter le Rapport de Portefeuille" },
  "Upcoming Limited Auction": { en: "Upcoming Limited Auction", fr: "Enchère Limitée à Venir" },
  "VIP Attendance Confirmed": { en: "VIP Attendance Confirmed", fr: "Présence VIP Confirmée" },
  "Confirm Premium Attendance": { en: "Confirm Premium Attendance", fr: "Confirmer la Présence Premium" },
  "Last updated:": { en: "Last updated:", fr: "Dernière mise à jour :" },
  "Prestige Account Active": { en: "Prestige Account Active", fr: "Compte Prestige Actif" },
  "Hello, Julian.": { en: "Hello, Julian.", fr: "Bonjour, Julian." },
  "Quick Access — Site Pages": { en: "Quick Access — Site Pages", fr: "Accès Rapide — Pages du Site" },
  "Navigate to the public gallery sections.": { en: "Navigate to the public gallery sections.", fr: "Naviguez vers les sections publiques de la galerie." },
  "Registering...": { en: "Registering...", fr: "Enregistrement..." },
  "Acquired": { en: "Acquired", fr: "Acquis le" },
  "Provenance File": { en: "Provenance File", fr: "Dossier de Provenance" },
  "Curator's Premium Choice": { en: "Curator's Premium Choice", fr: "Choix Premium du Conservateur" },
